# 📝 Taller Práctico 2: Los Componentes del PC y Presentaciones Efectivas

**Nivel:** Básico - Intermedio
**Duración:** 60 Minutos
**Herramientas:** Microsoft PowerPoint y Microsoft Excel (Básico).

---

## 🎯 Objetivo
Comprender la función visual de cada componente interno del PC y saber crear un presupuesto sencillo y una presentación profesional para exponer la información.

## 🛠️ Actividades Críticas

### 1. Creación de una Presentación (Uso de PowerPoint)
...
1. Copia la tabla que acabas de hacer en Excel.
2. Pégala en la **Diapositiva 3** de tu presentación de PowerPoint.
3. En la **Diapositiva 4 (Conclusiones)**, escribe un párrafo breve sobre cuál crees que es el componente que más influye para que Excel y Word abran más rápido y por qué.

## 💡 Entregable Final
Guarda la presentación final como `Taller2_Presentacion_Nombre.pptx`. No necesitas entregar el archivo de Excel separado, ya que la tabla estará en las diapositivas.
